...
export const LOCATION_IDS: readonly LocationId[] = ['guard_van', 'dining', 'corridor', 'cabin', 'vestibule', 'salon', 'kitchen', 'mail', 'bath', 'smoking', 'platform'] as const;

/** Every location that is a place in the consist, by index along the train. */
export const CARRIAGE_LOCATION_IDS: readonly LocationId[] = ['guard_van', 'dining', 'corridor', 'cabin', 'vestibule', 'salon', 'kitchen', 'mail', 'bath', 'smoking'] as const;
