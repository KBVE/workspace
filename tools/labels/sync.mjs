...
export function buildLock(families, projects) {
  ...
  return {
    ...
    // Project ids, for the conventional-commit scope check in tools/commit.
    // Derived here because this file is already the offline copy of the graph,
    // and a commit-msg hook cannot afford a moon run.
    scopes: projects.map((p) => p.id).sort(),
